...
const CurrencyExchangeSection = () => {
  return (
    <section className="w-full px-6 py-16 bg-white">
      <div className="mx-auto max-w-6xl rounded-2xl overflow-hidden grid grid-cols-1 lg:grid-cols-2 gap-0 min-h-[420px]">
        {/* LEFT — image */}
        ...
        {/* RIGHT — content */}
        <div className="relative bg-[#dce8fd] px-8 sm:px-12 py-12 flex flex-col justify-center">
          <p className="text-xs lg:text-lg font-bold tracking-widest text-[#1154da] uppercase mb-4">
            Currency Exchange
          </p>

          <h2 className="text-[36px] sm:text-[44px] font-extrabold text-[#1a0a2e] leading-[1.12] mb-5">
            {/* Convert money at
            <br />
            the best rates */}
          ...
          <p className="text-[15px] text-[#1154da] font-semibold leading-relaxed mb-6 max-w-sm">
            Effortlessly exchange major world currencies at live interbank
            rates. Convert from local to foreign and back — instantly, with zero
            hidden markups.
          </p>
