  ...
  return (
    <div className="min-h-screen bg-white text-white font-sans antialiased overflow-hidden">
      ...
      <section className="relative overflow-hidden bg-[#f8f9ff] -mt-14 lg:-mt-14">
        {/* Background */}
        <div className=" mx-auto max-w-[1600px] absolute inset-0 bg-[radial-gradient(circle_at_left,#eef3ff_0%,transparent_45%),radial-gradient(circle_at_bottom_right,#dbe8ff_0%,transparent_35%)]"></div>

        <div className="relative px-6 md:px-8 lg:px-10 py-20 lg:py-26">
